...
const DesktopHeader = () => {
  ...
  return (
    <div className='desktop-nav container' id='home' ref={headerRef}>
        <div className="wrapper desktop-nav--content">
            <div className="logo-box"><img className='logoHeader' src={logoHeader} alt='logo unmaze' onClick={scrollToTop} /></div>
